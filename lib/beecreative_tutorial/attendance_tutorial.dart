...
class AttendanceTutorial extends StatefulWidget {
  @override
  _AttendanceTutorialState createState() => _AttendanceTutorialState();
}

class _AttendanceTutorialState extends State<AttendanceTutorial> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xff78b04d),
      body: new Center(
        child: new Column(
              ...
              new Container(
                ...
                decoration: BoxDecoration(
                  image: new DecorationImage(
                    image: ExactAssetImage('assets/images/hands.png'),
                    fit: BoxFit.contain
                  )
                ),
              ),
